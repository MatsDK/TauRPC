...
const ARGS_MAP = {
  ...
  '':
    '{"test_bigint":["num"],"update_state":["new_value"],"multiple_args":["arg","arg2"],"method_with_alias":[],"get_app_handle":[],"with_sleep":[],"get_window":[],"test_option":[],"vec_test":["arg"],"test_result":["user"],"ev":["updated_value"],"test_io":["user"]}',
}
type Router = {

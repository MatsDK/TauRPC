...
const ARGS_MAP = {
  ...
  '':
    '{"test_option":[],"update_state":["new_value"],"get_app_handle":[],"ev":["updated_value"],"test_bigint":["num"],"method_with_alias":[],"multiple_args":["arg","arg2"],"get_window":[],"with_sleep":[],"test_io":["user"],"test_result":["user"],"vec_test":["arg"]}',

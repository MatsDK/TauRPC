...
const ARGS_MAP = {
  ...
  '':
    '{"test_result":["user"],"method_with_alias":[],"ev":["updated_value"],"vec_test":["arg"],"with_sleep":[],"multiple_args":["arg","arg2"],"get_window":[],"get_app_handle":[],"test_io":["user"],"test_option":[],"update_state":["new_value"]}',
}

...
export type TauRpcEventsInputTypes =
  ...
  | { proc_name: 'state_changed'; input_type: { type: string } }
...
const ARGS_MAP = {
  '':
    '{"get_app_handle":[],"test_io":["user"],"update_state":["new_value"],"ev":["updated_value"],"get_window":[],"with_sleep":[],"test_result":["user"],"method_with_alias":[],"vec_test":["arg"],"test_option":[],"multiple_args":["arg","arg2"]}',
  'events': '{"state_changed":["new_state"],"test_ev":[]}',
}

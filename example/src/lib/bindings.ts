...
const ARGS_MAP = {
  ...
  '':
    '{"test_option":[],"with_sleep":[],"get_app_handle":[],"test_result":["user"],"vec_test":["arg"],"multiple_args":["arg","arg2"],"ev":["updated_value"],"get_window":[],"update_state":["new_value"],"test_io":["user"],"method_with_alias":[]}',

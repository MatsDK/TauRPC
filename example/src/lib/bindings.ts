...
const ARGS_MAP = {
  ...
  '':
    '{"get_window":[],"test_io":["user"],"vec_test":["arg"],"with_sleep":[],"get_app_handle":[],"test_result":["user"],"update_state":["new_value"],"method_with_alias":[],"test_option":[],"ev":["updated_value"],"multiple_args":["arg","arg2"]}',
}

...
pub fn export_types(
    ...
    let header: Cow<'static, str> =
        String::from("// This file is generated by taurpc. Do not edit it directly.").into();

    let export_config = specta::ts::ExportConfig::new().bigint(specta::ts::BigIntExportBehavior::BigInt);

    specta::export::ts_with_cfg(&export_path, header, &export_config).unwrap();
